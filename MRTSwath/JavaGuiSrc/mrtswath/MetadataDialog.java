/******************************************************************************
    ...
    PURPOSE:  The purpose of this class is to create a GUI interface to display
              the more detailed information than the info box. This class
              contains JDialog derived class to properly dislay those detailed
              data.
...
/******************************************************************************
    NAME:     MetadataDialog()
    PURPOSE:  To customize and subclass from JDialog which is built-in class
    PROGRAM HISTORY
    Version  Date     Programmer                     Code  Reason
    -------  ----     ---------------------------    ----  --------------------
                      Gregg T. Stubbendieck, Ph.D.   Java  Original development
...
/******************************************************************************
    NAME:     MetadataDialog()
    PURPOSE:  To construct an the dialog object when invoked
...
/******************************************************************************
    ...
    PURPOSE:  To close and destroy this dialog window
...
/******************************************************************************
    NAME:     doFind()
    PURPOSE:  To this is an implementation function, which is called by
...
/******************************************************************************
    NAME:     initialize()
    PURPOSE:  Function to initialize the view metadata screen
...
/******************************************************************************
    NAME:     isFileRead()
    PURPOSE:  To check if the file is read
...
/******************************************************************************
    ...
    PURPOSE:  To read metadata into the view metadata text area.
    ...
    private void readMetadataIntoTextArea()
    {
        ...
        catch (IOException e)
        {
            JOptionPane.showMessageDialog(this,
                "Error reading metadata file: " + metadataFilename);
        } 
    }

/******************************************************************************
    NAME:     searchTextActivity
    PURPOSE:  To get the length of the text in the metadata
