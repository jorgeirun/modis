/******************************************************************************
    ...
    PURPOSE:  The purpose of this class is to create a data model based on
              ...
              isolate the data model for List box.
    ...
    1. The data model is designed based on document/view architecture to
       separate the data model from List box view.
******************************************************************************/
...
/******************************************************************************
    NAME:     ChooserListModel
    PURPOSE:  To implement a concrete ListModel class from ListModel
              interface. Most of the function prototypes are defined in the
              interface.
...
/******************************************************************************
    NAME:     addElement
    PURPOSE:  To add element to the model container - vector
    RETURN VALUE:
    PROGRAM HISTORY
    Version  Date     Programmer                     Code  Reason
    -------  ----     ---------------------------    ----  --------------------
...
******************************************************************************/
    ...
    {
        Enumeration mrtenum = list.elements();
        int index = 0;
        final String elementString = element.toString();

        final int endOfList = list.size();
        list.addElement(element);
        notifyListeners(new ListDataEvent(this, ListDataEvent.INTERVAL_ADDED,
            endOfList, endOfList));
    }

/******************************************************************************
    NAME:     addListDataListener
    PURPOSE:  To add list data listner
    RETURN VALUE:
    PROGRAM HISTORY
    Version  Date     Programmer                     Code  Reason
    -------  ----     ---------------------------    ----  --------------------
...
/******************************************************************************
    NAME:     getElementAt
    PURPOSE:  To retrieve the data element at specified index of vector
    RETURN VALUE:
    PROGRAM HISTORY
    Version  Date     Programmer                     Code  Reason
    -------  ----     ---------------------------    ----  --------------------
...
/******************************************************************************
    NAME:     getSize
    PURPOSE:  To retireve size of vector
    RETURN VALUE:
    PROGRAM HISTORY
    Version  Date     Programmer                     Code  Reason
    -------  ----     ---------------------------    ----  --------------------
...
/******************************************************************************
    ...
    PURPOSE:  To insert element at an index i
    RETURN VALUE:
    PROGRAM HISTORY
    Version  Date     Programmer                     Code  Reason
    -------  ----     ---------------------------    ----  --------------------
...
/******************************************************************************
    ...
    PURPOSE:  To notify listners - this is for event operations.
    RETURN VALUE:
    PROGRAM HISTORY
    Version  Date     Programmer                     Code  Reason
    -------  ----     ---------------------------    ----  --------------------
...
******************************************************************************/
    ...
    {
        Enumeration mrtenum = listeners.elements();
        while (mrtenum.hasMoreElements())
        {
            ListDataListener ldl = (ListDataListener)mrtenum.nextElement();
            switch (lde.getType())
            {
...
/******************************************************************************
    ...
    PURPOSE:  To remove an element at index i
    RETURN VALUE:
    PROGRAM HISTORY
    Version  Date     Programmer                     Code  Reason
    -------  ----     ---------------------------    ----  --------------------
...
/******************************************************************************
    ...
    PURPOSE:  To remove list data listners
    RETURN VALUE:
    PROGRAM HISTORY
    Version  Date     Programmer                     Code  Reason
    -------  ----     ---------------------------    ----  --------------------
