/******************************************************************************
    ...
    PURPOSE:  The purpose of this class is to create a data container to
              contain all of error information. This class looks a lot like
              a data structure.
...
public class ErrorHandler
{
    ...
    final static public int ERROR_GEOLOCNAME_FIELD =          -60;
    final static public int ERROR_OUTPUTTYPE_FIELD =          -61;
    final static public int ERROR_ELLIPSOID =                 -62;
    final static public int ERROR_MISMATCHED_QUOTE =          -63;
    ...
    final static public int ERROR_MISSING_GEOLOC_FILE_NAME =  -118;
    final static public int ERROR_MISSING_OUTPUT_FILE_TYPE =  -119;

    final static public int NUM_ERROR_CODES =                  120;

/******************************************************************************
    NAME:     formalMessage
    PURPOSE:  This just defines a string array of message info.
    ...
    PROJECT:  MRTSwath
    NOTES:
    1. This is NOT a function definition.
******************************************************************************/
    final static public String[] formalMessage =
    {
        ...
        "Bad or Missing GEOLOCATION_FILENAME Field", /* -60 */

        "Bad or Missing OUTPUT_FILE_FORMAT Field",
        "Bad or Missing OUTPUT_PROJECTION_SPHERE Field",
        ...
        "Missing GEOLOC_FILENAME field in the .prm file!",  // -118
        "Missing OUTPUT_FILE_FORMAT field in the .prm file!",  // -119
        "Unknown error.", // -120
    };
}
